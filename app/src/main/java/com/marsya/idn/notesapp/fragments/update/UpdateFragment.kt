package com.marsya.idn.notesapp.fragments.update
...
import com.marsya.idn.notesapp.R
import com.marsya.idn.notesapp.data.model.NoteData
import com.marsya.idn.notesapp.data.viewModelsData.NotesViewModel
import com.marsya.idn.notesapp.databinding.FragmentUpdateBinding
import com.marsya.idn.notesapp.fragments.SharedViewModels
...
class UpdateFragment : Fragment() {
    ...
    private fun confirmItemRemoval() {
        AlertDialog.Builder(requireContext())
            .setTitle("Delete '${args.curentitem.tittle}' ? ")
            .setMessage("Are you sure want to remove '${args.curentitem.tittle}' ?")
            .setPositiveButton("Yes"){_, _ ->
                mNotesViewModel.deleteData(args.curentitem)
                Toast.makeText(
                    requireContext(),"Succesfully Removed : ${args.curentitem.tittle}",
                    Toast.LENGTH_SHORT
                ).show()
    ...
    private fun updateItem(){
        val title = binding.etUptittle.text.toString()
