package com.marsya.idn.notesapp.fragments.add
...
import com.marsya.idn.notesapp.databinding.FragmentAddBinding
...
class AddFragment : Fragment() {
    ...
    private fun insertDataToDatabase() {
        val mTitle = addBinding.etTittle.text.toString()
