package com.marsya.idn.notesapp.fragments.list
...
import com.marsya.idn.notesapp.databinding.FragmentListBinding
import com.marsya.idn.notesapp.fragments.SharedViewModels
import com.marsya.idn.notesapp.fragments.adapter.ListAdapter
import com.marsya.idn.notesapp.utils.hideKeyboard
...
class ListFragment : Fragment(), SearchView.OnQueryTextListener {
    ...
    private fun confirmRemoveAll(){
        AlertDialog.Builder(requireContext())
            .setTitle("Delete All?")
            .setMessage("Are you sure want to remake all ?")
